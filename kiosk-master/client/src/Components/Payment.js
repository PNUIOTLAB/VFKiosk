    ...
    <>
      ...
      <Template0>
        <ButtonGroup color="primary" aria-label="large outlined primary button group">
          <Link to={"/end"}>
            <Button variant='text' style={{backgroundColor:"#fd6257"}} className={classes.root} onClick={deleteStockandaddCustomer}>
              <Typography style={{fontWeight:"900",fontSize: "22px"}}>
              <div>신용카드</div>
              <div>결제</div></Typography>
            </Button>
          </Link>
          <Link to={"/end"}><Button variant='text' style={{backgroundColor:"#6ae98a"}} className={classes.root} onClick={deleteStockandaddCustomer}>
            현금 결제</Button></Link>
          <Link to={"/end"}><Button variant='text' style={{backgroundColor:"yellow",padding:"0"}} className={classes.root} onClick={deleteStockandaddCustomer}>
